...
def vis_detections(im, class_name, class_category, dets, thresh=0.8):
    ...
    for i in range(np.minimum(10, dets.shape[0])):
        ...
        score = dets[i, -1]
        if score > thresh:
            bbox_left, bbox_top = bbox[0:2]
            bbox_width, bbox_height = bbox[2:4][0] - bbox[0:2][0], bbox[2:4][1]-bbox[0:2][1]
            Res_bbox.append([bbox_left, bbox_top, bbox_width, bbox_height, score, class_category,-1,-1])
